class Audit < ActiveRecord::Base
  ...
  def combined_entries
    unless @combined_entries
      ...
      server_entries.each { |e| @combined_entries[e['serial_number']] ||= Hash.new; @combined_entries[e['serial_number']][:server] = e }
      db_entries.each { |e| @combined_entries[e.serial_number] ||= Hash.new; @combined_entries[e.serial_number][:db] = e }
    end
