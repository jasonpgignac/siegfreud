...
describe Audit do
  before :each do 
    ...
    @server_data = [
        {:serial_number => "1", :name => "C-1", :domain => "TEST.COM", :owner => "kissingerh"},
        {:serial_number => "2", :name => "C-2", :domain => "TEST.COM", :owner => "kissingerh"},
        {:serial_number => "5", :name => "C-5", :domain => "TEST.COM", :owner => "kissingerh"},
        {:serial_number => "6", :name => "C-6", :domain => "TEST.COM", :owner => "kissingerh"},
        {:serial_number => "7", :name => "C-7", :domain => "TEST.COM", :owner => "kissingerh"},
        {:serial_number => "8", :name => "C-8", :domain => "BAD.COM", :owner => "kissingerh"}
    ]
    @service.stub!(:info_for).with(@site).and_return @server_data
    ...
    Computer.stub!(:find_all_by_site_id).with(@site.id, 
        :conditions => {:platform => "Mac", :domain_id => @domain.id}).and_return @db_data
  end
